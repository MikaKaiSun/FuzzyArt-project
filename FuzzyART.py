...
training_file = 'C:\\Users\\Kai\\Desktop\\fuzzy-art\\TrainingData.txt' 
testing_file = 'C:\\Users\\Kai\\Desktop\\fuzzy-art\\TestingData.txt'
...
while True:
    ...
    print ("Cluster list's length: ", len(novellist))
